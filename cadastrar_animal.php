...
<html>
    <head>
        <title>Sistema Animal | Perfil Pet</title>
                    ...
                    <div class="main-content perfil_usuario perfil_pet">
                        ...
                        <div class="bottom-content">
                            <div class="job-description">
                                <div class="header">
                                    <span>Cadastre seu Gato</span>
                                </div>
                                <?php
                                include_once './view/meupet_cadastrogato.php';
                                ?>
                                <div class="header">
                                    <span>Cadastre seu Cão</span>
                                </div>
                                <?php
                                include_once './view/meupet_cadastrocao.php';
                                ?>
